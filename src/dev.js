...
const eventDispatcher = document.getElementById('ext-submit')
const placeNameInput = document.getElementById('ext-placename')
const coordinatesInput = document.getElementById('ext-coordinates')
